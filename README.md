...
<p>The closest point we obtained to the global minimum corresponds to bidding prices shown in the table below. There is a missing entry due to the fact that we have no data from any customer of that type. The resulting cost per purchase is $4.26, and the purchase rate is 4.03%. Note that the raw data has the cost of purchase of $23.98 and the purchase rate of 7.83% with the uniform bidding price of $10. However, the numerical values rely on our assumption that <img src="https://latex.codecogs.com/svg.image?a_i=-0.5" title="a_i=-0.5" /> and should be treated as such. </p>
<p align="center">
<img src = "Full_optimization_table.png" width="500"></img>
</p>
